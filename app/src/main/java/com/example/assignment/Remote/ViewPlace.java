...
import com.example.assignment.Model.PlaceDetail;
...
public class ViewPlace extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        //mService = Commons.getGoogleAPISerivce();
      ...
      /* btn_show_map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent mapIntent = new Intent(Intent.ACTION_VIEW, Url.parse(mPlace.getResult().getUrl()));
        ...
        /*if(Commons.currentResult.getPhotos() != null && Commons.currentResult.getPhotos().length >0){
            Picasso.with(this)
                    .load(getPhotoOfPlace(Commons.currentResult.getPhotos()[0].getPhoto_references(),1000))
       ...
       /* if(Common.currentResult.getOpening_hours()!=null){
        ...
        //place
       /* mService.getDetailPlace(getPlaceDetailUrl(Commons.currentResult.getResult.getPlace_id()))
                .enqueue(new Callback<PlaceDetail>() {
                   public void onResponse(Call<PlaceDetail> call, Response<PlaceDetail> response){
                    ...
                    public void onResponse(Call<PlaceDetail> call, Throwable t){
